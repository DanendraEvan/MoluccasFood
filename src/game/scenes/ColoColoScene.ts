...
export default class ColoColoScene extends Phaser.Scene {
  ...
  private createHintPopup() {
    ...
    // Title header
    const title = this.add.text(0, -popupHeight / 2 + 45, 'Sambal Colo-Colo', {
      fontSize: '28px',
