...
const COOKING_INSTRUCTIONS: Record<string, string[]> = {
  ...
  ikankuahkuning: [
    ...
    "bumbu su masa, mari katong giling kas halus. Ambe ana cobe, taro dalam cobe. sudah?. Ayo katong giling bumbu sampe halus",
    "Ambel tacu dari menu, taro di atas kompor. Sudah? Kase masuk bumbu halus, aduk sampai harum.",
    "kase maso daong salam, sareh, deng lengkuas kadalam tacu. katong aduk akang ",
  ...
  papeda: [
    "Selamat datang di game TFM su siap masa papeda hari ini? ambe mangko dari menu, taro dimeja. sudah? ambe sagu manta dari lalu taro didalam mangko.",
    "su kas maso sagu manta? sakarang katong tuang aer 200 mL kadalam mangko.",
    ...
    "Par tamba rasa katong ambe tomi-tomi la peras akang diatas adonan sagu manta. tekan tomi-tomi ulang-ulang sampe aer tomi-tomi kaluar la kasi maso dalam adonan.",
  ...
  kohukohu: [
    ...
    "Bagus, sakarang kas pindah kalapa dari loyang ke teflon.",
    "Abis tu, katong sangrai kalapa, pake bila-bila par aduk. Geser kiri-kanang par aduk.",
    "Mantap! Sakarang katong siapkan sayor, kase maso daong kumange dalam tacu.",
    "Tarus, kase maso kacang panjang.",
    "Sakarang kase maso kangkong.",
