...
const FOOD_HINTS: Record<string, FoodHintInfo> = {
  kohukohu: {
    title: 'Kohu-Kohu',
    content: 'Koho-kohu adalah salah satu makanan khas Maluku yang sangat populer dan mudah ditemukan di berbagai daerah. Makanan ini merupakan sejenis salad segar yang terbuat dari campuran sayuran mentah seperti kacang panjang, kacang tumbu, kangkung, dan kemangi. Yang membuat kohu-kohu istimewa adalah bumbunya yang kaya rempah, terdiri dari kelapa parut. cabai rawit, bawang merah, bawang putih, garam, dan kadang ditambah ikan cakalang.'
  },
  colocolo: {
    title: 'Sambal Colo-Colo',
    content: 'Colo-colo adalah sambal khas Maluku yang memiliki cita rasa pedas dan segar. Sambal ini terbuat dari campuran cabai rawit merah, bawang merah, tomat, dan garam yang diulek kasar hingga tercampur rata. Yang membuat colo-colo unik adalah teksturnya yang tidak terlalu halus, sehingga masih terasa potongan-potongan kecil dari bahan-bahannya. Kadang-kadang ditambahkan perasan lemon cina untuk memberikan rasa asam segar yang menyeimbangkan rasa pedasnya. Colo-colo biasanya disajikan sebagai pelengkap berbagai makanan khas Maluku seperti ikan bakar, papeda, atau nasi putih. '
  },
  nasilapola: {
    title: 'Nasi Lapola',
