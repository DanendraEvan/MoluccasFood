...
export const kohuKohuSteps: DialogStep[] = [
  ...
  {
    id: 5,
    text: "Lanjutkan dengan memasukkan Kacang Panjang.",
    character: "karakter3",
...
export const papedaSteps: DialogStep[] = [
  ...
  {
    id: 2,
    text: "Step ke 2 ayo kita potong bungkus tepungnya. Klik terus pada Area tengah Tepung Sagu atas sampai tepung terbuka. Sudah? Selanjutnya ambil Tepung Sagu dan taruh pada Mangkuk di Meja.",
    character: "karakter2",
