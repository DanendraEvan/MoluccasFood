// src/pages/info/3.tsx - Kohu-Kohu Page with Clean Mobile Design
        ...
        >
          ...
          <div className="flex flex-row items-center" style={{ gap: '0' }}>
            ...
            <div className="flex-shrink-0" style={{ paddingLeft: '1px', paddingRight: '1px' }}>
              ...
              >
                <Image
                  src="/assets/makanan/kohukohu.png"
                  alt="Kohu-Kohu"
                  fill
                  style={{
                    objectFit: 'contain',
